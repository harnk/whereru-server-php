...
catch (Exception $e)
{
	...
	if (APPLICATION_ENV == 'development')
		...
		echo "SCXTT FAILED WITH EXCEPTION: ";
		var_dump($e);
...
class API
{
	...
	{
		echo "IN API Constructor ";
		// Create a connection to the database.
		echo " 00 before new PDO  ";
		echo "config is " . $config;
		echo " setting mysql:host to be " . 'mysql:host=' . 'localhost' . ';dbname=altcoinf_pushwhereruprod,altcoinf_pushw,d]682\#%yI1nb3';
		$this->pdo = new PDO(
			'mysql:host=localhost' . ';dbname=altcoinf_pushwhereruprod', 
			'altcoinf_pushw', 
			'd]682\#%yI1nb3',
